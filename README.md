...
NOTE: the HOST variable should _not_ including a trailing slash.  So `heroku config:set HOST=https://secure-sands-4512.herokuapp.com` instead of `heroku config:set HOST=https://secure-sands-4512.herokuapp.com/`
